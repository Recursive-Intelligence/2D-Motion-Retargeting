...
def handle2x(config, args):
    ...
    # out12 is the predicted keypoints of the retargeted
    # motion.
    # TODO: Extract out12 in the form of json keypoints data
    print(out12, out21)
    print(out12.shape, out21.shape)
...
def main():
    ...
    parser.add_argument(
        "-v1", "--vid1_json_dir", type=str, help="video1's openpose json directory"
    )
    parser.add_argument(
        "-v2", "--vid2_json_dir", type=str, help="video2's openpose json directory"
    )
    parser.add_argument(
        "-v3", "--vid3_json_dir", type=str, help="video3's openpose json directory"
    )
